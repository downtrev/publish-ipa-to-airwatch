...
#          Set your airwatch server in the {airwatchServer} variable
#
#
#   $1 - Authentication
#   $2 - TenantCode
...
USAGE="Usage: createUploadJson.sh [Authentication] [BinaryFilePath]"
...
airwatchServer="https://yourserver.awmdm.com"
...
curl -vX POST -H "Authorization: Basic $1" -H "aw-tenant-code: $2" $airwatchServer/api/mam/apps/internal/uploadchunk -d @${uploadJson} --header "Content-Type: application/json" > ${uploadResult}
...
curl -vX POST -H "Authorization: Basic $1" -H "aw-tenant-code: $2" $airwatchServer/api/mam/apps/internal/begininstall -d @${beginInstallJson}  --header "Content-Type: application/json" > ${installResult}
